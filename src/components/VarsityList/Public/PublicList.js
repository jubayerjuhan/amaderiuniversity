      ...
      <div className="list">
        <div className="publiclist">
          ...
          <p>
            ...
            students. These universities are funded by the government while
            managed as self-governed organizations. Dhaka division is home to
            thirteen public universities, among which eight are in Dhaka City.
            There are seven public universities in Chittagong division, six in
            Rajshahi division five in Khulna division, four in Mymensingh
            Division. Each of Rangpur division, Sylhet division &amp; Barisal
            division has two. as of 2020 the University Grants Commission of
            Bangladesh has introduce the cluster system for students enrollment.
          </p>
        </div>
        <div>
        ...
        <table className="tableplist">
          <tbody>
            ...
            <tr>
              <td>01</td>
              <td>
                <a href="https://du.edu.bd">Dhaka University</a>
              </td>
              <td>DU</td>
              <td>1921</td>
              <td>Dhaka</td>
