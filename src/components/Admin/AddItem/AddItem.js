               ...
               <div className="col-md-12">
                   <div><form className="p-3 container col-6" onSubmit={handleSubmit(onSubmit)}>
                                    <div className="form-group text-primary text-center">
                                        ...
                                        <input style={{  borderRadius: '15px',border: '2px solid #0000FF'}} type="text" ref={register({ required: true })} name="title" placeholder="Enter Item Name" className="form-control" />
                                    ...
                                    <div className="form-group row mb-1 d-flex justify-content-center">
                                        <div className="form-group col-6 text-primary text-center">
                                            ...
                                            <input step="any"  style={{  borderRadius: '15px',border: '2px solid #0000FF'}} type="number" ref={register({ required: true })} name="price" placeholder="Price" className="form-control" />
                                    ...
                                    <div className="row">
                                        <div className="form-group col-md-12 text-primary text-center">
                                            ...
                                            <textarea style={{height: "90px", borderRadius: '20px',border: '2px solid #0000FF' }} type="text" ref={register({ required: true })} name="description" placeholder="Description" className="form-control" />
